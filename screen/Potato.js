...
const PRODUCT = {
  ...
  description: `These farm-fresh potatoes are perfect for every meal — handpicked and chemical-free.`
};
...
const REVIEW = {
  user: "Ravi",
  rating: 5,
  text: "These potatoes are super fresh and very clean. Will buy again!"
};

export default function PotatoScreen({ navigation }) {
